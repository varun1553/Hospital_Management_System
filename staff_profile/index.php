...
if(!isset($_SESSION['username']))
{
   ...
   include '../dbConfig.php';
	...
	{
		$id  = $_GET['id'];
		$query = "select * from staff_registration where id = '$id'";
...
<html>
<head>
	<title>SRI-AROGYA | STAFF PROFILE</title>
...
<body>
	...
	<div class="container"><br>
		<h4 style="text-align: center ;font-family:'Arial Rounded MT Bold',Arial,Helvetica,sans-serif; font-weight: bold; ">Staff Details</h4><br>
		<h5 style="text-align: right;">Employee ID : <b style="color:orange;"> GPM/<?php echo $row['Employee_ID']; ?> </b> </h5><br>
			<fieldset class="border p-2">
		 		<legend  class="w-auto" style="font-size: 22px;font-family: bold;">Staff Details</legend>
		 		...
		 		<div class="row">
					...
					<th width="25%"  colspan="3"><?php echo $row['Employee_Name']; ?></th>
		       ...
		       <td  width="25%" style="text-align: right;">Blood Group : </td>
				...
				<tr>
					...
					<td width="25%" style="text-align: right;"> Mobile No. :</td>
				        <th width="25%"colspan="2" ><?php echo $row['Employee_Mobile_Number']; ?></th>
		    ...
		    <a href="../Staff_Details" class="btn btn-primary mt-3 ">Back</a>
		</div>
		    <br>
