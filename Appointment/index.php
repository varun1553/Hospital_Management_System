...
if(isset($_POST['appointmentbtn']))
{
  ...
  $query = mysqli_query($conn,"INSERT INTO appointment_details(Patient_Id,Token_Number,Type,Doctor,Fees,Validity_Period,Time_Slots,op_date,created_datetime,created_by)VALUES('$patient_id','$token','$type','$doctor','$fees','$validity_period','$time_slots','$op_date','$created_datetime','$created_by')");
		...
		<h4 style="text-align: center ;font-family:'Arial Rounded MT Bold',Arial,Helvetica,sans-serif; font-weight: bold; ">Appointment</h4><br>
			...
			<fieldset class="border p-2">
				...
				<div class="row">
				  ...
				  <div class="col-md-4">
					<input type="text" required="" name="fees" class="form-control"  value="" style="border-radius: 7px; background-color: #e1ebfc;">
				  </div>			      
			    </div>
			    <br>
			    <div class="row">
